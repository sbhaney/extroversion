...
```
QualityOfDay = 149.121 − 25.672(HoursSocializing) − 21.288(Extraversion_Score) + 7.348(HoursSocializing×Extraversion_Score)

HoursSocializing alone decreases QualityOfDay.
Extraversion_Score alone decreases QualityOfDay.
BUT when people are high in both HoursSocializing and Extraversion, the negative effects are partially cancelled out (positive interaction effect).
